...
<header>
	<div class="top">
		...
		<a href="/WebPiano/index.php?c=video" class="top-left">视频站</a>
	...
	<div class="index_opern_left">
		<?php if($isopern == 1): ?><div class="oleft">
            ...
            <div class="oright" id="show">
                ...
                <div class="ysjc" onclick="play()">演示教程</div>
                <div class="tzys" onclick="stopplay()">停止演示</div>
...
<script>
	...
	<script src="/WebPiano/Public/js/jiaoben/qby.js"></script>
</body>